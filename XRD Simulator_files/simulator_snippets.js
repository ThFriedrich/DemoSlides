...
const imgSeqAnimation = (exitLoop, initIMG, topIMG, canvasData, nextFun = empty_fn, updateFun, millsecs = 15) => {
    imgSeqTimeout = setTimeout(() => {
        imgSeq = requestAnimationFrame(function () {
            imgSeqAnimation(exitLoop, initIMG, topIMG, canvasData, nextFun, updateFun, millsecs);
        });
        currentImg++;
