    ...
    $.slickQuiz = function (element, options) {
        ...
        plugin.method = {
            ...
            setupQuiz: function (options) { // use 'options' object to pass args
                ...
                if (quizValues.info.main && quizValues.info.main !== '') {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        var ColumnLayout = $('<div class="quiz-image-column"></div>');
                        var answerDiv = $('<div class="quiz-answer-column"></div>');
                        if (question.img && question.img !== '') {
                            ColumnLayout = $('<div class="quiz-two-column" style="display: flex; justify-content: space-between; align-items: center; justify-content: center;"></div>');
                            var imageDiv = $('<div class="quiz-image-column" style="max-height: 500px;"></div>');
                            imageDiv.append('<img src="' + question.img + '" alt="Question Image" style="height: 400px;" />');
                            ColumnLayout.append(imageDiv);
                        } 
                        ColumnLayout.append(answerDiv);
                        ...
                        questionHTML.append(ColumnLayout);
            ...
            completeQuiz: function (options) {
                ...
                if (plugin.config.disableRanking) {
                    ...
                    $(_quizLevel + ' span').html(levelText).css('font-size', '3em');
